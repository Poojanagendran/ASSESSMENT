...
class OnlineAssessment:
    ...
    def __init__(self):
        self.row = 1
        write_excel_object.save_result(output_path_ui_rtc_marking_schema)
        header = ['rtc test marking']
        ...
        header = ['Test Cases', 'Status', 'Test Id', 'Candidate Id', 'Testuser ID', 'User Name', 'Password',
                  ...
                  'Actual Qn21 mark', 'Expected Qn id22', 'Actual Qn id22', 'Expected Qn22 mark',
                  'Actual Qn22 mark', 'Expected Qn id23', 'Actual Qn id23', 'Expected Qn23 mark',
                  'Actual Qn23 mark']
    ...
    def mcq_marking(self, tu_details, token):
        ...
        if login_details == 'SUCCESS':
            ...
            if i_agreed:
                ...
                assess_ui_common_obj.select_answer_for_the_question(tu_details.get('ans_qid16'))
                assess_ui_common_obj.next_question(17)
                assess_ui_common_obj.select_answer_for_the_question(tu_details.get('ans_qid17'))
                assess_ui_common_obj.next_question(18)
                assess_ui_common_obj.select_answer_for_the_question(tu_details.get('ans_qid18'))
                assess_ui_common_obj.next_question(19)
                assess_ui_common_obj.select_answer_for_the_question(tu_details.get('ans_qid19'))
                assess_ui_common_obj.next_question(20)
                assess_ui_common_obj.select_answer_for_the_question(tu_details.get('ans_qid20'))
                assess_ui_common_obj.next_question(21)
                assess_ui_common_obj.select_answer_for_the_question(tu_details.get('ans_qid21'))
                assess_ui_common_obj.next_question(22)
                assess_ui_common_obj.select_answer_for_the_question(tu_details.get('ans_qid22'))
                assess_ui_common_obj.next_question(23)
                assess_ui_common_obj.select_answer_for_the_question(tu_details.get('ans_qid23'))
        ...
        group2_section1_obtained_mark = mark_details['data']['groupAndSectionWiseMarks'][1]['sectionInfo'][0][
            'obtainedMarks']
        all_questions = mark_details['data']['referenceToContext']
        # id = 121404
...
excel_read_obj.excel_read(input_path_ui_marking_schema, 1)
