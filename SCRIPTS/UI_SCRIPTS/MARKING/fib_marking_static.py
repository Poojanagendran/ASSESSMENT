...
class OnlineAssessment:
    ...
    def __init__(self):
        self.row = 1
        write_excel_object.save_result(output_path_ui_fib_marking_schema)
        header = ['FIB test marking']
    ...
    def fib_marking(self, tu_details, token):
        ...
        if login_details == 'SUCCESS':
            ...
            if i_agreed:
                ...
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid1'))
                assess_ui_common_obj.next_question(2)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid2'))
                assess_ui_common_obj.next_question(3)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid3'))
                assess_ui_common_obj.next_question(4)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid4'))
                assess_ui_common_obj.next_question(5)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid5'))
                assess_ui_common_obj.next_question(6)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid6'))
                assess_ui_common_obj.next_question(7)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid7'))
                assess_ui_common_obj.next_question(8)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid8'))
                assess_ui_common_obj.next_question(9)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid9'))
                assess_ui_common_obj.next_question(10)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid10'))
                assess_ui_common_obj.next_question(11)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid11'))
                assess_ui_common_obj.next_question(12)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid12'))
                assess_ui_common_obj.next_question(13)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid13'))
                assess_ui_common_obj.next_question(14)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid14'))
                assess_ui_common_obj.next_question(15)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid15'))
                assess_ui_common_obj.next_question(16)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid16'))
                assess_ui_common_obj.next_question(17)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid17'))
                assess_ui_common_obj.next_question(18)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid18'))
                assess_ui_common_obj.next_question(19)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid19'))
                assess_ui_common_obj.next_question(20)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid20'))
                assess_ui_common_obj.next_question(21)
                assess_ui_common_obj.select_answer_for_fib_question(tu_details.get('ans_qid21'))
        ...
        group2_section1_obtained_mark = mark_details['data']['groupAndSectionWiseMarks'][1]['sectionInfo'][0][
            'obtainedMarks']
        all_questions = mark_details['data']['fillInTheBlank']
        # id = 121404
...
excel_read_obj.excel_read(input_path_ui_marking_schema, 5)
...
for current_excel_row in excel_data:
    ...
    assessment_obj.fib_marking(current_excel_row, crpo_token)
