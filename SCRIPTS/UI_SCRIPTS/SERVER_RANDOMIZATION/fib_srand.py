...
class QPVerification:
    ...
    def __init__(self):
        self.row = 1
        write_excel_object.save_result(output_path_ui_fib_randomization)
        ...
        self.expected_low_section1_group1 = ['po q1 FIB serverrand automation low',
                                             'po q2 FIB serverrand automation low',
                                             'po q3 FIB serverrand automation low']
        self.expected_medium_section1_group1 = ['po q4 FIB serverrand automation medium',
                                                'po q5 FIB serverrand automation medium',
                                                'po q6 FIB serverrand automation medium']
        self.expected_high_section1_group1 = ['po q7 FIB serverrand automation high',
                                              'po q8 FIB serverrand automation high',
                                              'po q9 FIB serverrand automation high']

        self.expected_low_section2_group1 = ['po q10 FIB serverrand automation low',
                                             'po q11 FIB serverrand automation low']
        self.expected_medium_section2_group1 = ['po q12 FIB serverrand automation medium',
                                                'po q13 FIB serverrand automation medium']
        self.expected_high_section2_group1 = ['po q14 FIB serverrand automation high',
                                              'po q15 FIB serverrand automation high']

        self.expected_low_section1_group2 = ['po q16 FIB serverrand automation low',
                                             'po q17 FIB serverrand automation low',
                                             'po q18 FIB serverrand automation low',
                                             'po q19 FIB serverrand automation low',
                                             'po q20 FIB serverrand automation low']
        self.expected_medium_section1_group2 = ['po q21 FIB serverrand automation medium',
                                                'po q22 FIB serverrand automation medium',
                                                'po q23 FIB serverrand automation medium',
                                                'po q24 FIB serverrand automation medium',
                                                'po q25 FIB serverrand automation medium']
        self.expected_high_section1_group2 = ['po q26 FIB serverrand automation high',
                                              'po q27 FIB serverrand automation high',
                                              'po q28 FIB serverrand automation high',
                                              'po q29 FIB serverrand automation high',
                                              'po q30 FIB serverrand automation high']

        self.expected_low_section2_group2 = ['po q31 FIB serverrand automation low',
                                             'po q32 FIB serverrand automation low',
                                             'po q33 FIB serverrand automation low',
                                             'po q34 FIB serverrand automation low',
                                             'po q35 FIB serverrand automation low']
        self.expected_medium_section2_group2 = ['po q36 FIB serverrand automation medium',
                                                'po q37 FIB serverrand automation medium',
                                                'po q38 FIB serverrand automation medium',
                                                'po q39 FIB serverrand automation medium',
                                                'po q40 FIB serverrand automation medium']
        self.expected_high_section2_group2 = ['po q41 FIB serverrand automation high',
                                              'po q42 FIB serverrand automation high',
                                              'po q43 FIB serverrand automation high',
                                              'po q44 FIB serverrand automation high',
                                              'po q45 FIB serverrand automation high']
...
excel_read_obj.excel_read(input_path_ui_mcq_randomization, 6)
