...
class QPVerification:
    ...
    def __init__(self):
        self.row = 1
        write_excel_object.save_result(output_path_ui_draw_randomization)
        ...
        self.expected_low_section1_group1 = ['po q1 draw serverrand automation low',
                                             'po q2 draw serverrand automation low',
                                             'po q3 draw serverrand automation low']
        self.expected_medium_section1_group1 = ['po q4 draw serverrand automation medium',
                                                'po q5 draw serverrand automation medium',
                                                'po q6 draw serverrand automation medium']
        self.expected_high_section1_group1 = ['po q7 draw serverrand automation high',
                                              'po q8 draw serverrand automation high',
                                              'po q9 draw serverrand automation high']

        self.expected_low_section2_group1 = ['po q10 draw serverrand automation low',
                                             'po q11 draw serverrand automation low']
        self.expected_medium_section2_group1 = ['po q12 draw serverrand automation medium',
                                                'po q13 draw serverrand automation medium']
        self.expected_high_section2_group1 = ['po q14 draw serverrand automation high',
                                              'po q15 draw serverrand automation high']

        self.expected_low_section1_group2 = ['po q16 draw serverrand automation low',
                                             'po q17 draw serverrand automation low',
                                             'po q18 draw serverrand automation low',
                                             'po q19 draw serverrand automation low',
                                             'po q20 draw serverrand automation low']
        self.expected_medium_section1_group2 = ['po q21 draw serverrand automation medium',
                                                'po q22 draw serverrand automation medium',
                                                'po q23 draw serverrand automation medium',
                                                'po q24 draw serverrand automation medium',
                                                'po q25 draw serverrand automation medium']
        self.expected_high_section1_group2 = ['po q26 draw serverrand automation high',
                                              'po q27 draw serverrand automation high',
                                              'po q28 draw serverrand automation high',
                                              'po q29 draw serverrand automation high',
                                              'po q30 draw serverrand automation high']

        self.expected_low_section2_group2 = ['po q31 draw serverrand automation low',
                                             'po q32 draw serverrand automation low',
                                             'po q33 draw serverrand automation low',
                                             'po q34 draw serverrand automation low',
                                             'po q35 draw serverrand automation low']
        self.expected_medium_section2_group2 = ['po q36 draw serverrand automation medium',
                                                'po q37 draw serverrand automation medium',
                                                'po q38 draw serverrand automation medium',
                                                'po q39 draw serverrand automation medium',
                                                'po q40 draw serverrand automation medium']
        self.expected_high_section2_group2 = ['po q41 draw serverrand automation high',
                                              'po q42 draw serverrand automation high',
                                              'po q43 draw serverrand automation high',
                                              'po q44 draw serverrand automation high',
                                              'po q45 draw serverrand automation high']
...
excel_read_obj.excel_read(input_path_ui_mcq_randomization, 8)
