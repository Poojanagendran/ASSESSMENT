...
class QPVerification:
    ...
    def __init__(self):
        self.row = 1
        write_excel_object.save_result(output_path_ui_mca_randomization)
        ...
        self.expected_low_section1_group1 = ['po q1 mca serverrand automation low',
                                             'po q2 mca serverrand automation low',
                                             'po q3 mca serverrand automation low']
        self.expected_medium_section1_group1 = ['po q4 mca serverrand automation medium',
                                                'po q5 mca serverrand automation medium',
                                                'po q6 mca serverrand automation medium']
        self.expected_high_section1_group1 = ['po q7 mca serverrand automation high',
                                              'po q8 mca serverrand automation high',
                                              'po q9 mca serverrand automation high']

        self.expected_low_section2_group1 = ['po q10 mca serverrand automation low',
                                             'po q11 mca serverrand automation low']
        self.expected_medium_section2_group1 = ['po q12 mca serverrand automation medium',
                                                'po q13 mca serverrand automation medium']
        self.expected_high_section2_group1 = ['po q14 mca serverrand automation high',
                                              'po q15 mca serverrand automation high']

        self.expected_low_section1_group2 = ['po q16 mca serverrand automation low',
                                             'po q17 mca serverrand automation low',
                                             'po q18 mca serverrand automation low',
                                             'po q19 mca serverrand automation low',
                                             'po q20 mca serverrand automation low']
        self.expected_medium_section1_group2 = ['po q21 mca serverrand automation medium',
                                                'po q22 mca serverrand automation medium',
                                                'po q23 mca serverrand automation medium',
                                                'po q24 mca serverrand automation medium',
                                                'po q25 mca serverrand automation medium']
        self.expected_high_section1_group2 = ['po q26 mca serverrand automation high',
                                              'po q27 mca serverrand automation high',
                                              'po q28 mca serverrand automation high',
                                              'po q29 mca serverrand automation high',
                                              'po q30 mca serverrand automation high']

        self.expected_low_section2_group2 = ['po q31 mca serverrand automation low',
                                             'po q32 mca serverrand automation low',
                                             'po q33 mca serverrand automation low',
                                             'po q34 mca serverrand automation low',
                                             'po q35 mca serverrand automation low']
        self.expected_medium_section2_group2 = ['po q36 mca serverrand automation medium',
                                                'po q37 mca serverrand automation medium',
                                                'po q38 mca serverrand automation medium',
                                                'po q39 mca serverrand automation medium',
                                                'po q40 mca serverrand automation medium']
        self.expected_high_section2_group2 = ['po q41 mca serverrand automation high',
                                              'po q42 mca serverrand automation high',
                                              'po q43 mca serverrand automation high',
                                              'po q44 mca serverrand automation high',
                                              'po q45 mca serverrand automation high']
...
excel_read_obj.excel_read(input_path_ui_mcq_randomization, 5)
