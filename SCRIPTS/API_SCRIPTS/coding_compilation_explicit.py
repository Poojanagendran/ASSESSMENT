"""
Coding compilation explicit: validates code compilation and test case execution with explicit API calls.

Run directly: from project root, python -m SCRIPTS.API_SCRIPTS.coding_compilation_explicit
