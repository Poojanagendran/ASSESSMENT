"""
Applicant report: generates and compares applicant reports (job, event, requirement, assessment).

Run directly: from project root, python -m SCRIPTS.API_SCRIPTS.applicant_report
