"""
Reuse test score: validates score reuse functionality when candidate retakes a test.

Run directly: from project root, python -m SCRIPTS.API_SCRIPTS.reuse_test_score
