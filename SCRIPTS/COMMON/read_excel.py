...
class ExcelRead:
    ...
    def __init__(self):
        self.details = []
        self.details1 = {}
        # file_path = '/home/muthumurugan/Desktop/Automation1/Assessment_Shortlisting2.xls'
        # sheet_index = 0
    ...
    def excel_read(self, excel_file_path, sheet_index):
        ...
        headers_available_in_excel = self.excel_sheet_index.row_values(0)
        exp_headers = {}
        ...
        for row_by_index in range(1, self.excel_sheet_index.nrows):
            ...
            self.details.append(self.details1)
