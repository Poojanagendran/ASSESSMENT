...
output_path_ui_mcq_randomization = output_common_dir + r'\UI\UI_mcq_qprandomization.xls'
output_path_ui_rtc_server_random = output_common_dir + r'\UI\UI_rtc_server_qprandomization_'
output_path_ui_coding_randomization = output_common_dir + r'\UI\UI_coding_qprandomization.xls'
output_path_ui_subjective_randomization = output_common_dir + r'\UI\UI_subjective_qprandomization.xls'
output_path_ui_mcqww_randomization = output_common_dir + r'\UI\UI_mcqww_qprandomization.xls'
output_path_ui_mca_randomization = output_common_dir + r'\UI\UI_mca_qprandomization.xls'
output_path_ui_fib_randomization = output_common_dir + r'\UI\UI_fib_qprandomization.xls'
output_path_ui_video_randomization = output_common_dir + r'\UI\UI_video_qprandomization.xls'
output_path_ui_draw_randomization = output_common_dir + r'\UI\UI_draw_qprandomization.xls'
