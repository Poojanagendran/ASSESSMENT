...
output_path_behaviour_proctor_evaluation_new = output_common_dir + r'/Assessment/proctoring/api_face_liveliness'
...
# Log path
log_reuse_score = output_common_dir + r'/Logs/reuse_score_' + started + '.log'
