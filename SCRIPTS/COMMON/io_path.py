...
output_path_proctor_evaluation = output_common_dir + r'/API_proctoring_eval100'
output_path_dev_proctor_evaluation = output_common_dir + r'/API_device_proctoring_eval'
output_path_face_liveliness_proctor_evaluation = output_common_dir + r'/API_face_liveness_pro_eval'
output_path_blur_virtual_proctor_evaluation = output_common_dir + r'/API_blur_virtual_pro_eval'
output_path_gaze_detection_evaluation = output_common_dir + r'/API_gaze_detection_eval'
output_path_code_cheat_proctor_evaluation = output_common_dir + r'/API_code_cheat_pro_eval'
output_path_behaviour_proctor_evaluation_new = output_common_dir + r'/api_behaviour_liveliness'
output_path_behaviour_proctor_evaluation = output_common_dir + r'/API_behaviour_proctoring_eval'
...
output_question_statistics = output_common_dir + r'/API_qn_statisctis'
output_question_statistics_tests = output_common_dir + r'/API_qn_statisctis_tests'
output_question_statistics_new_cron = output_common_dir + r'/API_qn_statisctis_new_cron'
output_question_statistics_tests_hp_cron = output_common_dir + r'/API_hp_qn_statisctis_tests'
output_path_sanitize_automation = output_common_dir + r'/API_sanitize - '
output_path_sanitize_test_automation = output_common_dir + r'/API_sanitize_test - '
output_path_sanitize_testuser_automation = output_common_dir + r'/API_sanitize_testuser - '
output_path_emails = output_common_dir + r'/emails'
output_path_sa_web_report = output_common_dir + r'/API_sa_webreport - '
...
output_path_ui_sql_compilation = output_common_dir + r"/UI/sql_compilation.xls"
output_path_ui_coding_compilation = output_common_dir + r"/UI/coding_compilation.xls"
